...
/**
 * Generates and verifies Base64 tokens used to protect against Cross Site Request Forgery. Uses the {@link
 * SecureRandom} number generator when generating the tokens.
 */
public class CsrfProtector
{
    ...
    /**
     * Creates a new {@link CsrfProtector}. The maximum number of tokens that can be registered with the {@link
     * CsrfProtector} is set to 10.
     *
     * @param entropy The entropy of the tokens generated by the {@link CsrfProtector} in bytes.
     */
    ...
    /**
     * Creates a new {@link CsrfProtector}. The entropy of the tokens generated by the {@link CsrfProtector} in bytes is
     * set to 32. The maximum number of tokens that can be registered with the {@link CsrfProtector} is set to 10.
     */
    ...
    /**
     * Verifies that the provided {@code token} is registered with the {@link CsrfProtector}. Removes the token
     * afterwards.
     *
     * @param token The token to verify.
     * @return {@code true} when the token could be verified.
