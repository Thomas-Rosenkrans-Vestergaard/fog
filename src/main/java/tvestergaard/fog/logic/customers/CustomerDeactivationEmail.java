...
/**
 * The email sent to customers when their account is deactivated.
 */
public class CustomerDeactivationEmail implements ApplicationEmail
{
    ...
    /**
     * Creates a new {@link CustomerDeactivationEmail}.
     *
     * @param customer The customer the email is sent to.
     */
    public CustomerDeactivationEmail(Customer customer)
    {
